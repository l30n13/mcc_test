...
import com.mcc.l30n.mcc.adapter.GalleryRecyclerAdapter;
import com.mcc.l30n.mcc.databinding.ActivityGalleryBinding;
...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.rvGallery.setLayoutManager(new GridLayoutManager(GalleryActivity.this, 2));
        binding.srlGallery.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                binding.srlGallery.setRefreshing(true);
                getGallery();
            }
        });
        binding.srlGallery.setRefreshing(true);
    ...
    public void getGallery() {
        binding.rvGallery.setAdapter(new GalleryRecyclerAdapter(GalleryActivity.this, imageUrls));
        binding.srlGallery.setRefreshing(false);
    }
